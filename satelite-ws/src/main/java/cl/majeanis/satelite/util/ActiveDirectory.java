...
public class ActiveDirectory
{
    ...
    { "distinguishedName", "cn", "name", "uid", "sn", "givenname", "memberOf", "samaccountname", "userPrincipalName" };
    ...
    // *************************************************************************/
    /**
     * Used to authenticate a user given a username/password. Domain name is derived
     * from the fully qualified domain name of the host machine.
     */

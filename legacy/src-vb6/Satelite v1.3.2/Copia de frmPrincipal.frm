...
Begin VB.Form frmPrincipal 
   ...
   Begin VB.Frame fraGrillas 
      ...
      Top             =   0
      Width           =   5235
      Begin FPSpread.vaSpread grdResultado 
         Height          =   1335
         Left            =   120
         OleObjectBlob   =   "frmPrincipal.frx":038A
         TabIndex        =   2
         Top             =   180
         Width           =   1995
      End
   ...
   Begin ComctlLib.ImageList Iconos 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmPrincipal.frx":0597
            Key             =   "carpeta"
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmPrincipal.frx":0AE9
            Key             =   "consulta1"
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmPrincipal.frx":103B
            Key             =   "usuario"
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmPrincipal.frx":158D
            Key             =   "grupal"
         EndProperty
         BeginProperty ListImage5 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmPrincipal.frx":1ADF
            Key             =   "area"
         EndProperty
         BeginProperty ListImage6 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmPrincipal.frx":2031
            Key             =   "consulta"
         EndProperty
         BeginProperty ListImage7 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmPrincipal.frx":2583
            Key             =   "lote"
         EndProperty
      EndProperty
   End
   Begin VB.OLE OLE1 
      ...
      Height          =   390
      Left            =   5820
      OleObjectBlob   =   "frmPrincipal.frx":2AD5
      TabIndex        =   4
      Top             =   3720
      Visible         =   0   'False
      Width           =   1170
...
Sub ActivarBotones()
    ...
    Case "USU", "COM", "PER", "LCO"
        ...
        mnuArcNuevaCarpeta.Enabled = (msNomUsuarioLocal = Environ("username")) And (Left(mNode.Tag, 3) = "USU")
        mnuPopNuevaCarpeta.Enabled = (msNomUsuarioLocal = Environ("username")) And (Left(mNode.Tag, 3) = "USU")
    ...
    Case "DIR"
        ...
        mnuArcNuevaCarpeta.Enabled = (msNomUsuarioLocal = Environ("username"))
        mnuPopNuevaCarpeta.Enabled = (msNomUsuarioLocal = Environ("username"))
        mnuArcEliminarCarpeta.Enabled = (msNomUsuarioLocal = Environ("username"))
        mnuPopEliminarCarpeta.Enabled = (msNomUsuarioLocal = Environ("username"))
    ...
    Case Else
        ...
        Else
            ...
            mnuPopCarNuevaConsulta.Enabled = ("" & mrsUsuarioLocal!ind_crear_consultas = "S")
            mnuPopConNuevaConsulta.Enabled = ("" & mrsUsuarioLocal!ind_crear_consultas = "S")
            mnuArcEditarConsulta.Enabled = ("" & mrsUsuarioLocal!ind_modificar_consultas = "S")
            mnuPopEdiEditar.Enabled = ("" & mrsUsuarioLocal!ind_modificar_consultas = "S")
            mnuArcMoverConsulta.Enabled = (msNomUsuarioLocal = Environ("username"))
            mnuPopMoverConsulta.Enabled = (msNomUsuarioLocal = Environ("username"))
        End If
    
        mnuEdiBuscarTexto.Enabled = (mnTotalRegUltQuery > 0)
        mnuEdiBuscarSgte.Enabled = False
        mnuArcEjecutar.Enabled = ("" & mrsUsuarioLocal!ind_ejecutar_consultas = "S")
        ...
        mnuPopEdiEjecutar.Enabled = ("" & mrsUsuarioLocal!ind_ejecutar_consultas = "S")
...
Sub ArcEliminarCarpeta()
    ...
    If Left(mNode.Tag, 3) = "DIR" Then
        ...
        Call EliminaCarpetasDeSetting(sFolderIni)
...
Sub CargaConsultas(sNomUsuario As String)
    ...
    If db_LeeConsultasPorUsuario(msNomUsuarioLocal, rsData) Then
        While Not rsData.EOF
            ...
            sNomDueño = "" & rsData!nom_dueno
            sKey = "SQL" & "_" & sNumConsulta
            sTag = sKey & ";" & sNomDueño
            
            If msNomUsuarioLocal = Environ("username") Then
                sKeyPadre = LCase(GetSetting(App.Title, "Consultas", sKey, sNomUsuario))
            Else
                sKeyPadre = sNomUsuario
            End If
            
            Call CargaHijo(sNomUsuario, sKeyPadre, sKey, sTag, sNomConsulta)
...
Sub CargaFormulario()
    ...
    If msNomUsuarioLocal = Environ("username") Then
        Call CargaCarpetasDeSetting(msNomUsuarioLocal, tvTreeView, nMaxKey)
    End If
    
    OpenMyDataBase
    
    Call CargaConsultas(msNomUsuarioLocal)
    Call CargaAgrupaciones("COM")
    Call CargaLotes("LCO")
...
Public Sub CargaAgrupaciones(sCodPadre As String)
    ...
    If db_LeeConsultasAgrupacionPorUsuario(msNomUsuarioLocal, rsData) Then
        While Not rsData.EOF
            ...
            Set mNode = tvTreeView.Nodes.Add(sCodPadre & "_" & sNumPerfil, tvwChild, sCodLlave, sNomConsulta, "consulta")
            mNode.Tag = "SQL" & "_" & sNumConsulta
...
Sub CargaHijo(sNomUsuario As String, sKeyPadre As String, sKeyNodo As String, sTagNodo As String, sNombre As String)
    Dim nNode       As Node
    
    On Error GoTo SinNodoPadre
    
    Set nNode = tvTreeView.Nodes.Add(sKeyPadre, tvwChild, , sNombre, "consulta")
    nNode.Tag = sTagNodo
...
SinNodoPadre:
    ...
    Set nNode = tvTreeView.Nodes.Add(sNomUsuario, tvwChild, , sNombre, "consulta")
    nNode.Tag = sTagNodo
...
Public Sub ExportarExcel()
    ...
    If Not gbCancelar Then
        Call ExportarAExcel(Me.Caption, grdResultado, grsConsulta, grsFormatos, ProgressBar1, StatusBar1)
    End If
End Sub
...
Sub LeeDetalleConsulta(bEjecutar As Boolean)
    Dim nPos            As Integer
    Dim sNomDueño       As String

 ...
 * @author mzavaleta
 */
public class DB_Consulta extends DB_Base {

    public DB_Consulta(Connection cn) {
        super(cn);
    }

    public DB_Consulta(Connection cn, Properties props) {
        this(cn);
        this.props = props;
    }

    public BE_Consulta get(int id) throws SQLException {
        BE_Consulta be_Consulta = null;
        String query = getQuery("getConsulta");
        PreparedStatement pst = cn.prepareStatement(query);
        pst.setInt(1, id);
        ResultSet rs = pst.executeQuery();
        if (rs.next()) {
            be_Consulta = new BE_Consulta();
            ...
            BE_BDatos be_BDatos = new BE_BDatos();
    ...
    public void add(BE_Consulta consulta, String userLogin) throws SQLException {
        String comando =
                "insert into st_cns\n"
                + "  (id_bdt,\n"
                + "   id_gru,\n"
    ...
    public void save(BE_Consulta consulta, String userLogin) throws SQLException {
        String comando =
                "update st_cns set\n"
                + "  id_bdt=?,\n"
                + "   id_gru=?,\n"
    ...
    public ArrayList<BE_Consulta> getLastByUsr(String usrLogin) throws SQLException {
